...
namespace Extend\CustomSLO\ViewModel;
...
//CustomSLO
use Extend\CustomSLO\Model\Config\Source\ProductPagePlacement;
...
class Warranty implements ArgumentInterface
{
    ...
    public function getProductDetailPageOffersPlacement(bool $isSimpleProduct): array
    {
        ...
        switch ($pdpDisplay) {
            ...
            case ProductPagePlacement::SLO_SPECIAL:
                $placement['insertionPoint'] = 'div.credova-response-amount';
		        $placement['insertionLogic'] = $logicAfter;
            break;
